...
public class LessonThreeTask2 {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("--- Создание партий фрутов --------------------");
        ...
        // Сравнение коробок
        System.out.println("--- Сравнения коробок -------------------------");
        ...
        System.out.println("--- Переложить коробоки в одну -------------------");
        System.out.println(appleBox);
